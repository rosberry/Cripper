...
final class CripperTests: XCTestCase {
    ...
    func testPositiveRectCrop() {
        ...
        let missingImage = UIImage.bundledImage(named: "image_257_167_287_269.png").rerendered()
        XCTAssertTrue(croppedImage.compare(missingImage, accuracy: 1))
    }
    ...
    func testEllipseRectCrop() {
        ...
        let missingImage = UIImage.bundledImage(named: "ellipse_257_167_287_269.png").rerendered()
        XCTAssertTrue(croppedImage.compare(missingImage, accuracy: 1000))
    }
    ...
    func testForceTopLeftRectCrop() {
        ...
        let rect = CGRect(x: -100, y: -100, width: 287, height: 269)
        let croppedImage = image.rectCrop(rect: rect)
        let missingImage = UIImage.bundledImage(named: "image_-100_-100_287_269.png").rerendered()
        XCTAssertFalse(croppedImage.compare(missingImage, accuracy: 0.01))
    }
}
